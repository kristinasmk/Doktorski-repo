function [ACarchive, ACstate, ACcontrol,WPTi,ACmode] = trajectorygen_Weather_v3 (ACstate,...
    ACcontrol, Wind, ACmode, dT, SimulationTime, WPTi,FFP, ...
    waypoints, opsdata, apfdata, GP, const, timestep, ACarchive,...
    AstarGrid,cloudMap,CloudsAll, NeighboorsTable,loctime)
...
while ACmode.StillFlying
    ...
    ACarchive(timestep,21)=loctime+timestep;
