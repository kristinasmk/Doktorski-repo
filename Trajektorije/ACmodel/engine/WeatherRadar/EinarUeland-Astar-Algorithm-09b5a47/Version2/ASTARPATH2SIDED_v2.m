     function [OptimalPath,OpenedMAT]=ASTARPATH2SIDED_v2(StartX,StartY,MAP,GoalX,GoalY,Connecting_Distance,NeighboorsTable)
%Version 1.0
% clear
% load INN
% GoalX=110;
...
% a=ASL
if RECONSTRUCTPATH
    %if CurrentX4~=StartX && CurrentY4~=StartY
...
%if exist('OptimaPath','var')
 OptimalPath=[flipud(OptimalPath); (OptimalPathEnd)];
%else
%    OptimalPath=OptimalPathEnd;
end
